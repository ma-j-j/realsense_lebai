...
public:
    ...
    void yolo_ROI(cv::Mat inputImage, std::vector<Yolo::Detection> Input, cv::Mat &color_ROI, cv::Mat &depth_ROI, cv::Mat black_image, cv::Mat in_depth, cv::Mat out_depth, std::vector<cv::Point2d> &out_Center);
